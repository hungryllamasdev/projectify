...
const Column = ({ title, headingColor, cards, column, setCards, onUpdateTask }: ColumnProps) => {
  ...
  return (
    <>
      ...
      <motion.div
        ...
        layoutId={id}
        draggable="true"
        onDragStart={(e) => handleDragStart(e, { id, title, status, priority, type, dueDate } as Task)}
